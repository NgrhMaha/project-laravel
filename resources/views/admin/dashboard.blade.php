<x-template-layout>
  ...
  <div class="container px-5 py-2 mx-5 flex flex-col">
    <div class="lg:w-6/6 mx-4">
      <div class="rounded-lg h-80 w-90 overflow-hidden">
        <img alt="content" class="object-cover object-center h-full w-full" src="https://dummyimage.com/1200x500">
      </div>
      <div class="flex flex-col sm:flex-row mt-10">
        <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
          <div class="w-20 h-20 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400">
            <img class="rounded-full" src="{{asset('storage/covers/owner.jpg')}}" alt="">
          ...
          <div class="flex flex-col items-center text-center justify-center">
            <h2 class="font-medium title-font mt-4 text-gray-900 text-lg">Owner</h2>
            <div class="w-12 h-1 bg-indigo-500 rounded mt-2 mb-4"></div>
            <p class="text-base">" Kami mengutamakan kenyamanan pelanggan dengan pelayanan yang ramah "</p>
          </div>
        </div>
...
<!-- steps -->
<section class="text-gray-600 body-font">
  <div class="container px-5 py-2 mx-5 my-5 flex flex-wrap">
